...
function LayersMenuCommon()
{
	...
	$this->dirroot = './';
	$this->libjsdir = ROOT.'libs/menulibs/libjs/';
	$this->imgdir = ROOT.'libs/img/';
	$this->imgwww = URL.'libs/img/';
	$this->icondir = ROOT.'libs/img/'; 
	$this->iconwww = URL.'libs/img/';
