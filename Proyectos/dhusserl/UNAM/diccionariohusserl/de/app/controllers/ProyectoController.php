...
*/
class Proyecto  extends helperController {
	...
	function displayContent(){
		$query="select * from pantallas_texto where pantalla_name='proyecto' and pantalla_lang='de'";
	...
	function saveContentForm(){
		$query="update pantallas_texto set  pantalla_content='".$_POST['textfield']."' where
			pantalla_name='proyecto' and pantalla_lang='de'";
		if(!($set=$this->localFetch($query))){
