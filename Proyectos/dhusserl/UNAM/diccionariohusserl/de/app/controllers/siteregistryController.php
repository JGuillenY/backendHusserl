...
class siteregistry extends helperController{
	...
	function index(){
        ...
        function showForm(){
        	...
        	$var.="<fieldset class='crud'><legend class='crud'>Register</legend>";
	...
	function registrarForm(){
        	...
        	if(!$this->registerUser($POST)){
        		...
        		$url=URL."?action=siteaccess";
			$text="<div class='green2'>".$this->text['registersuccess']."".$POST['mail']." <a href='$url'>Fortsetzen...</a></div>";
