...
$ROOT="/home/clafenor/public_html/diccionariohusserl/de/";        //RAIZ DEL SISTEMA DE ARCHIVOS DONDE ESTA UBICADO EL SISTEMA
$URL='//www.clafen.org/diccionariohusserl/de/';       //URL DEL SISTEMA
...
//VARIABLES DEL MENU
$TITLE="Husserl W&ouml;rterbuch";	//TITULO QUE APARECE EN EL NAVEGADOR
$DIVTITLE="font-face: bold; font-family: berliner,arial,sans-serif,helvetica;font-size: 17px;color: #521410;";
$MENUFOOTER="<br><div align='center'><a href='../es/'><div class=normal>Versi&oacute;n en Espa&ntilde;ol</div>
		<img src='public/es.gif' border='0' height='30' width='40'/>
		</a></div>";
...
$DB['CHARSET']="";				    //CHARSET BASE DE DATOS (ORACLE)
